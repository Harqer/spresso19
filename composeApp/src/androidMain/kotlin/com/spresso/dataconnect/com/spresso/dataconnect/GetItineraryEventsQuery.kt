...
public fun GetItineraryEventsQuery.ref(
...
public suspend fun GetItineraryEventsQuery.execute(
  ...
  public fun GetItineraryEventsQuery.flow(
    
    ): kotlinx.coroutines.flow.Flow<GetItineraryEventsQuery.Data> =
    ref(
