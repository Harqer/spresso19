...
public fun GetWardrobeOutfitsQuery.ref(): com.google.firebase.dataconnect.QueryRef<
    GetWardrobeOutfitsQuery.Data,
    Unit,
> =
    ref(
...
public suspend fun GetWardrobeOutfitsQuery.execute(): com.google.firebase.dataconnect.QueryResult<
    GetWardrobeOutfitsQuery.Data,
    Unit,
> =
    ref().execute()

public fun GetWardrobeOutfitsQuery.flow(): kotlinx.coroutines.flow.Flow<GetWardrobeOutfitsQuery.Data> =
    ref()
        .subscribe()
        .flow
