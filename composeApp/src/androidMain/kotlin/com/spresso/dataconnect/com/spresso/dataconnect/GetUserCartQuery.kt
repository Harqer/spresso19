...
public fun GetUserCartQuery.ref(): com.google.firebase.dataconnect.QueryRef<
    GetUserCartQuery.Data,
    Unit,
> =
    ref(
...
public suspend fun GetUserCartQuery.execute(): com.google.firebase.dataconnect.QueryResult<
    GetUserCartQuery.Data,
    Unit,
> =
    ref().execute()

public fun GetUserCartQuery.flow(): kotlinx.coroutines.flow.Flow<GetUserCartQuery.Data> =
    ref()
        .subscribe()
        .flow
