...
public fun GetCreativeTemplatesQuery.ref(
...
public suspend fun GetCreativeTemplatesQuery.execute(
  ...
  public fun GetCreativeTemplatesQuery.flow(
    
    ): kotlinx.coroutines.flow.Flow<GetCreativeTemplatesQuery.Data> =
    ref(
