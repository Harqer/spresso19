...
public fun GetVoiceNotesQuery.ref(
...
public suspend fun GetVoiceNotesQuery.execute(
  ...
  public fun GetVoiceNotesQuery.flow(
    
    ): kotlinx.coroutines.flow.Flow<GetVoiceNotesQuery.Data> =
    ref(
