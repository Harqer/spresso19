...
public fun GetPaymentMethodsQuery.ref(
...
public suspend fun GetPaymentMethodsQuery.execute(
  ...
  public fun GetPaymentMethodsQuery.flow(
    
    ): kotlinx.coroutines.flow.Flow<GetPaymentMethodsQuery.Data> =
    ref(
