...
public fun GetTravelExpensesQuery.ref(): com.google.firebase.dataconnect.QueryRef<
    GetTravelExpensesQuery.Data,
    Unit,
> =
    ref(
...
public suspend fun GetTravelExpensesQuery.execute(): com.google.firebase.dataconnect.QueryResult<
    GetTravelExpensesQuery.Data,
    Unit,
> =
    ref().execute()

public fun GetTravelExpensesQuery.flow(): kotlinx.coroutines.flow.Flow<GetTravelExpensesQuery.Data> =
    ref()
        .subscribe()
        .flow
