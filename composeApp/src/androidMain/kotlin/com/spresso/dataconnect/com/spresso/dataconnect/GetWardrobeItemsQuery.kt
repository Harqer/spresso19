...
public fun GetWardrobeItemsQuery.ref(
...
public suspend fun GetWardrobeItemsQuery.execute(
  ...
  public fun GetWardrobeItemsQuery.flow(
    
    ): kotlinx.coroutines.flow.Flow<GetWardrobeItemsQuery.Data> =
    ref(
