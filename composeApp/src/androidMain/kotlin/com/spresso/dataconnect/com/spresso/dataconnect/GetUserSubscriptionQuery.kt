...
public fun GetUserSubscriptionQuery.ref(
...
public suspend fun GetUserSubscriptionQuery.execute(
  ...
  public fun GetUserSubscriptionQuery.flow(
    
    ): kotlinx.coroutines.flow.Flow<GetUserSubscriptionQuery.Data> =
    ref(
