    ...
    >
{
  ...
  public data class Variables(
    ...
    val outfitId: com.google.firebase.dataconnect.OptionalVariable<@kotlinx.serialization.Serializable(with = com.google.firebase.dataconnect.serializers.UUIDSerializer::class) java.util.UUID?>,
        ...
        public fun build(
          ...
          return object : Builder {
            override var outfitId: java.util.UUID?
              ...
              set(value_) { outfitId = com.google.firebase.dataconnect.OptionalVariable.Value(value_) }
            ...
            override var brand: String?
              get() = throw UnsupportedOperationException("getting builder values is not supported")
              set(value_) { brand = com.google.firebase.dataconnect.OptionalVariable.Value(value_) }
          ...
          .let {
            Variables(
              outfitId=outfitId,category=category,brand=brand,imageUrl=imageUrl,color=color,
            )
          }
        }
      }
