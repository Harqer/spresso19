...
public fun GetCreatorAgentsQuery.ref(
...
public suspend fun GetCreatorAgentsQuery.execute(
  ...
  public fun GetCreatorAgentsQuery.flow(
    
    ): kotlinx.coroutines.flow.Flow<GetCreatorAgentsQuery.Data> =
    ref(
