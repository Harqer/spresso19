...
public fun GetUserPreferenceQuery.ref(
...
public suspend fun GetUserPreferenceQuery.execute(
  ...
  public fun GetUserPreferenceQuery.flow(
    
    ): kotlinx.coroutines.flow.Flow<GetUserPreferenceQuery.Data> =
    ref(
