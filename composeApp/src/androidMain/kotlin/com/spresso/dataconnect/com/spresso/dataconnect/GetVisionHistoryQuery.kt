...
public fun GetVisionHistoryQuery.ref(): com.google.firebase.dataconnect.QueryRef<
    GetVisionHistoryQuery.Data,
    Unit,
> =
    ref(
...
public suspend fun GetVisionHistoryQuery.execute(): com.google.firebase.dataconnect.QueryResult<
    GetVisionHistoryQuery.Data,
    Unit,
> =
    ref().execute()

public fun GetVisionHistoryQuery.flow(): kotlinx.coroutines.flow.Flow<GetVisionHistoryQuery.Data> =
    ref()
        .subscribe()
        .flow
