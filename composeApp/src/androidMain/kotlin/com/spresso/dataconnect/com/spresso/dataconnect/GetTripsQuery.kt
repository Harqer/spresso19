...
public fun GetTripsQuery.ref(): com.google.firebase.dataconnect.QueryRef<
    GetTripsQuery.Data,
    Unit,
> =
    ref(
...
public suspend fun GetTripsQuery.execute(): com.google.firebase.dataconnect.QueryResult<
    GetTripsQuery.Data,
    Unit,
> =
    ref().execute()

public fun GetTripsQuery.flow(): kotlinx.coroutines.flow.Flow<GetTripsQuery.Data> =
    ref()
        .subscribe()
        .flow
