...
public fun GetOnboardingStatusQuery.ref(): com.google.firebase.dataconnect.QueryRef<
    GetOnboardingStatusQuery.Data,
    Unit,
> =
    ref(
...
public suspend fun GetOnboardingStatusQuery.execute(): com.google.firebase.dataconnect.QueryResult<
    GetOnboardingStatusQuery.Data,
    Unit,
> =
    ref().execute()

public fun GetOnboardingStatusQuery.flow(): kotlinx.coroutines.flow.Flow<GetOnboardingStatusQuery.Data> =
    ref()
        .subscribe()
        .flow
