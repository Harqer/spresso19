...
public fun GetUserVideosQuery.ref(): com.google.firebase.dataconnect.QueryRef<
    GetUserVideosQuery.Data,
    Unit,
> =
    ref(
...
public suspend fun GetUserVideosQuery.execute(): com.google.firebase.dataconnect.QueryResult<
    GetUserVideosQuery.Data,
    Unit,
> =
    ref().execute()

public fun GetUserVideosQuery.flow(): kotlinx.coroutines.flow.Flow<GetUserVideosQuery.Data> =
    ref()
        .subscribe()
        .flow
