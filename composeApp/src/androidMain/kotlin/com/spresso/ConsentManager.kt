...
class ConsentManager(
    ...
    fun hasAnalyticsConsent(): Boolean = prefs.getBoolean("has_analytics_consent", false)

    fun grantAnalyticsConsent() {
        prefs.edit().putBoolean("has_analytics_consent", true).apply()
    }

    fun hasCameraConsent(): Boolean = prefs.getBoolean("has_camera_consent", false)
...
val LocalConsentManager =
    staticCompositionLocalOf<ConsentManager> {
