...
class SpressoWearablesService : Service() {
    ...
    private fun handleIntentRouting(
        functionName: String,
        ...
        when (functionName) {
            ...
            "addToCart" -> {
                ...
                if (productId != null) {
                    ...
                    val intent =
                        Intent("com.spresso19.intent.action.ADD_TO_CART").apply {
    ...
    private fun createAndStartSession() {
        session =
            Wearables.createSession(AutoDeviceSelector()).getOrElse { error ->
                                            ...
                                            JSONArray().apply {
                                                put(
                                                    JSONObject().apply {
                                                        put(
                                                            "text",
                                                            "System Error: The glasses camera failed to capture a photo. Please inform the user.",
                                                        )
                                                    },
                                                )
                                            },
    ...
    private fun updateNotification(
        ...
        val notification =
            NotificationCompat
                .Builder(this, "spresso_wearables_channel")
    ...
    private fun createNotification(
        title: String = "Spresso Glasses Active",
        text: String = "Connected to Smart Glasses",
    ): Notification {
