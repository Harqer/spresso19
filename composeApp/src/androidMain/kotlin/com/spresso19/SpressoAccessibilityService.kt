...
class SpressoAccessibilityService : AccessibilityService() {
            ...
            override fun onReceive(
                ...
                when (intent?.action) {
                    ...
                    AccessibilityServiceCommands.ACTION_REQUEST_SCREEN_SCAN -> {
                        val token =
                            intent.getStringExtra(AccessibilityServiceCommands.EXTRA_REQUEST_TOKEN)
                                ?: return
                        val requestedAt =
                            intent.getLongExtra(
    ...
    override fun onServiceConnected() {
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.O) {
            accessibilityButtonController =
                getAccessibilityButtonController().also {
    ...
    private fun handleExplicitRequest(
    ...
    private suspend fun processScreenshot(
        ...
        try {
            ...
            if (response?.success == true) {
                ...
                val resultIntent =
                    Intent("com.spresso19.ACTION_SCAN_RESULT").apply {
    ...
    private fun containsSensitiveNode(
        node: AccessibilityNodeInfo,
        depth: Int = 0,
        budget: IntArray = intArrayOf(MAX_NODE_SCAN),
    ): Boolean {
    ...
    companion object {
        ...
        private val SENSITIVE_PACKAGE_MARKERS =
            setOf(
                "bank",
                "wallet",
                "payment",
        ...
        private val SENSITIVE_NODE_MARKERS =
            setOf(
                "password",
                "passcode",
                "one-time",
