                            ...
                            Row(
                                ...
                                Row(verticalAlignment = Alignment.CenterVertically, horizontalArrangement = Arrangement.spacedBy(10.dp)) {
                                    ...
                                    Column {
                                        ...
                                        Text("Expires ${card.expiryMonth}/${card.expiryYear}", fontSize = 11.sp, color = MaterialTheme.colorScheme.onSurfaceVariant)
                                    }
                                }
                                if (card.isDefault) {
                                    Surface(
                                        ...
                                        Text("Default", modifier = Modifier.padding(horizontal = 8.dp, vertical = 2.dp), fontSize = 10.sp, fontWeight = FontWeight.Bold)
                                    }
                                }
                            }
                        }
