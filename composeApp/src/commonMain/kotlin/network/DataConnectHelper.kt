...
expect suspend fun upsertUserPreference(
    theme: String?,
    pushNotifications: Boolean?,
    emailAlerts: Boolean?,
)

expect suspend fun upsertUserProfile(
    email: String?,
    displayName: String?,
    avatarUrl: String?,
)

expect suspend fun addGroceryItem(
    listId: String,
    productName: String,
    productId: String?,
    addedVia: String,
...
expect suspend fun toggleGroceryItem(
    id: String,
    isPurchased: Boolean,
)
...
expect suspend fun updateUserSubscription(
    id: String,
    tier: String,
)

expect suspend fun createOrder(
