...
const authDir = path.join(__dirname, 'src/components/features/auth');
if (!fs.existsSync(authDir)) fs.mkdirSync(authDir, { recursive: true });

// EmailAuthForm.tsx
fs.writeFileSync(path.join(authDir, 'EmailAuthForm.tsx'), `import React, { useState } from "react";
...
// PhoneAuthModal.tsx
fs.writeFileSync(path.join(authDir, 'PhoneAuthModal.tsx'), `import React, { useState } from "react";
...
// AuthScreen.tsx
fs.writeFileSync(path.join(authDir, 'AuthScreen.tsx'), `import React, { useState } from "react";
