...
This document summarizes the changes made to enforce Firebase Authentication across Spresso, following the `firebase-auth-basics` skill.

## 1. Backend Security (Express Server)

We implemented a global authentication middleware to protect all sensitive routes.

### [NEW] [authMiddleware.ts](file:///home/shaolin/Spresso/server/authMiddleware.ts)
...
### [MODIFY] [routes.ts](file:///home/shaolin/Spresso/server/routes.ts)
...
### [MODIFY] [firebase.ts](file:///home/shaolin/Spresso/src/lib/firebase.ts)
...
### [MODIFY] [ApiClient.kt](file:///home/shaolin/Spresso/composeApp/src/commonMain/kotlin/network/ApiClient.kt)
...
### [MODIFY] [firebase.json](file:///home/shaolin/Spresso/firebase.json)
