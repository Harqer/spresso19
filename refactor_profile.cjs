...
const profileDir = path.join(__dirname, 'src/components/features/profile');
const widgetsDir = path.join(profileDir, 'widgets');
const dialogsDir = path.join(profileDir, 'dialogs');

if (!fs.existsSync(widgetsDir)) fs.mkdirSync(widgetsDir, { recursive: true });
if (!fs.existsSync(dialogsDir)) fs.mkdirSync(dialogsDir, { recursive: true });

fs.writeFileSync(path.join(widgetsDir, 'ProfileHeader.tsx'), `import React, { useState, useEffect } from "react";
...
fs.writeFileSync(path.join(widgetsDir, 'MembershipPlansWidget.tsx'), `import React from "react";
import { MaterialIcon } from "../../../MaterialIcon";
...
fs.writeFileSync(path.join(widgetsDir, 'PaymentCardsWidget.tsx'), `import Logger from "../../../../lib/Logger";
...
fs.writeFileSync(path.join(widgetsDir, 'AppPreferencesWidget.tsx'), `import Logger from "../../../../lib/Logger";
...
fs.writeFileSync(path.join(widgetsDir, 'AccountDeactivationWidget.tsx'), `import Logger from "../../../../lib/Logger";
import React, { useState } from "react";
import { MaterialIcon } from "../../../MaterialIcon";
...
fs.writeFileSync(path.join(dialogsDir, 'SubscriptionModal.tsx'), `import React, { useState } from "react";
...
fs.writeFileSync(path.join(profileDir, 'ProfilePage.tsx'), `import Logger from "../../../lib/Logger";
import React, { useState, useEffect } from "react";
