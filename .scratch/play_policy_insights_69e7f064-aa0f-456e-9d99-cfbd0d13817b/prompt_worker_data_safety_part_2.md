...
- **Data Type**: USER_ACCOUNT
  *Description: Identifiers that relate to an identifiable person. For example, an account ID, account number, or account name.*
  - `composeApp/src/wasmJsMain/kotlin/network/AuthHelper.kt (Pattern: uid)`
- `dist/assets/index-BunGqtNk.js (Pattern: login)`
- **Data Type**: RACE_ETHNICITY
  *Description: Information about a user’s race or ethnicity.*
  - `dist/assets/index-BunGqtNk.js (Pattern: race)`
- `server.ts (Pattern: race)`
- `server/geminiService.ts (Pattern: race)`
- **Data Type**: PURCHASE_HISTORY
  *Description: Information about purchases or transactions a user has made.*
  - `dist/assets/index-BunGqtNk.js (Pattern: orderId)`
...
Save final JSON output to `/home/shaolin/Spresso/spresso19/.scratch/play_policy_insights_69e7f064-aa0f-456e-9d99-cfbd0d13817b/worker_data_safety_part_2.json`.
