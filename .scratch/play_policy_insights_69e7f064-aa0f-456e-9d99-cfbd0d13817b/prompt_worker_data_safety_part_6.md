...
- **Data Type**: PRECISE_LOCATION
  *Description: User or device physical location within an area less than 3 square kilometers, such as location provided by Android’s ACCESS_FINE_LOCATION permission.*
  - `server/routes.ts (Pattern: latitude)`
- **Data Type**: EMAIL
  *Description: A user’s email address.*
  - `dist/assets/index-BunGqtNk.js (Pattern: .email)`
- `server/routes.ts (Pattern: .email)`
- `src/App.tsx (Pattern: .email)`
- **Data Type**: PERFORMANCE_DIAGNOSTICS
  *Description: Information about the performance of your app. For example battery life, loading time, latency, framerate, or any technical diagnostics.*
  - `dist/assets/index-BunGqtNk.js (Pattern: Debug)`
- `server/geminiService.ts (Pattern: trace)`
...
Save final JSON output to `/home/shaolin/Spresso/spresso19/.scratch/play_policy_insights_69e7f064-aa0f-456e-9d99-cfbd0d13817b/worker_data_safety_part_6.json`.
