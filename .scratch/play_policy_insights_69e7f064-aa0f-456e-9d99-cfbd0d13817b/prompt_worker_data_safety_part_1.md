...
- **Data Type**: VIDEOS
  *Description: A user’s videos.*
  - `composeApp/src/androidMain/kotlin/audio/AudioRecorder.kt (Pattern: MediaRecorder)`
- `composeApp/src/androidMain/kotlin/com/spresso19/wearable/MetaWearablesManager.kt (Pattern: MediaRecorder)`
- **Data Type**: AUDIO
...
- **Data Type**: USER_ACCOUNT
  *Description: Identifiers that relate to an identifiable person. For example, an account ID, account number, or account name.*
  - `composeApp/src/androidMain/kotlin/network/AuthHelper.kt (Pattern: uid)`
...
Save final JSON output to `/home/shaolin/Spresso/spresso19/.scratch/play_policy_insights_69e7f064-aa0f-456e-9d99-cfbd0d13817b/worker_data_safety_part_1.json`.
