...
- **Data Type**: PURCHASE_HISTORY
  *Description: Information about purchases or transactions a user has made.*
  - `server.ts (Pattern: orderId)`
- `server/kitesurfService.ts (Pattern: orderId)`
- **Data Type**: FILES_AND_DOCS
  *Description: A user’s files or documents, or information about their files or documents such as file names.*
  - `composeApp/src/androidMain/kotlin/com/spresso19/MainActivity.kt (Pattern: text/plain)`
- `dist/assets/index-BunGqtNk.js (Pattern: */*)`
- `src/App.tsx (Pattern: localStorage)`
- **Data Type**: APPS_ON_DEVICE
  *Description: Information about the apps installed on a user's device.*
  - `composeApp/src/androidMain/kotlin/com/spresso19/MainActivity.kt (Pattern: getPackageInfo)`
...
Save final JSON output to `/home/shaolin/Spresso/spresso19/.scratch/play_policy_insights_69e7f064-aa0f-456e-9d99-cfbd0d13817b/worker_data_safety_part_3.json`.
