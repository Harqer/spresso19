...
- **Data Type**: PERFORMANCE_DIAGNOSTICS
  *Description: Information about the performance of your app. For example battery life, loading time, latency, framerate, or any technical diagnostics.*
  - `src/components/GenkitCreativeStudioModal.tsx (Pattern: trace)`
- **Data Type**: CRASH_LOGS
  *Description: Crash log data from your app. For example, the number of times your app has crashed, stack traces, or other information directly related to a crash.*
  - `dist/assets/index-BunGqtNk.js (Pattern: uncaughtException)`
- `src/components/AuthScreen.tsx (Pattern: Crashlytics)`
- `src/components/CameraObjectDetectionModal.tsx (Pattern: Crashlytics)`
- **Data Type**: CREDIT_DEBIT_BANK_ACCOUNT_NUMBER
  *Description: Information about a user’s financial accounts such as credit card number.*
  - `dist/assets/index-BunGqtNk.js (Pattern: stripe)`
- `src/components/HITLCheckoutModal.tsx (Pattern: credit_card)`
...
Save final JSON output to `/home/shaolin/Spresso/spresso19/.scratch/play_policy_insights_69e7f064-aa0f-456e-9d99-cfbd0d13817b/worker_data_safety_part_7.json`.
