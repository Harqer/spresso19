cat << 'INNER_EOF' > /home/shaolin/Spresso/composeApp/src/commonMain/kotlin/components/navigation/AdaptiveScaffoldBody.kt
                    ...
                    item(
                        ...
                        icon = {
                            if (item.icon != null) {
                                ...
                                Icon(org.jetbrains.compose.resources.vectorResource(item.iconResource), contentDescription = item.label)
                            }
                        },
