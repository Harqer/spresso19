    ...
    <div className="space-y-6 animate-fadeIn">
      <div className="bg-gradient-to-r from-[#e8f3e8] to-[#f2f8f2] p-6 rounded-3xl border border-[#d8ebd7] shadow-xs space-y-4">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-3">
          {[
            { mode: "HOT_SUMMER", icon: "wb_sunny", title: "Hot & Sunny (80°F+)", desc: "Shorts, Linen, Tees, Lightweight Dresses, Sandals", tempDefault: "85°F Sunny & Breezy" },
            { mode: "COLD_WINTER", icon: "ac_unit", title: "Cold Winter (30°F - 50°F)", desc: "Chunky Sweaters, Wool Coats, Denim, Jackets, Boots", tempDefault: "38°F Chilly Winter Day" },
        ...
        <div className="bg-white rounded-3xl border border-[#d8ebd7] shadow-sm p-6 space-y-6">
          <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3 border-b border-[#f2f8f2] pb-4">
            ...
            <div className="flex items-center space-x-2">
              ...
              <button onClick={() => onRandomizeShuffle(selectedWeatherMode, temperaturePrompt)} aria-label="Generate another combination" className="p-1.5 rounded-xl bg-stone-100 hover:bg-[#e8f3e8] text-[#18211e] transition cursor-pointer" title="Generate another combination">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 items-start">
            <div className="lg:col-span-8 space-y-4">
              ...
              <div className="p-4 bg-[#f2f8f2] border border-[#d8ebd7] rounded-2xl space-y-1 text-xs text-[#2d4d29]">
                <div className="flex items-center space-x-1.5 font-bold text-[#386633]"><MaterialIcon icon="psychology" size={16} /> <span>Spresso Personal Stylist Notes:</span></div>
