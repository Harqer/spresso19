...
export const WardrobeViewPage: React.FC<WardrobeViewProps> = ({
  ...
  return (
    <div className="space-y-6 pb-12 relative">
      ...
      <WardrobeHeaderToolbar isLoading={state.isLoading} itemCount={state.allWardrobeItems.length} onOpenUploadModal={() => interactions.setShowUploadModal(true)} onSelectAiGenerator={() => state.setActiveTab("AI_OUTFIT")} />
      ...
      {state.activeTab === "MIX_MATCH" && <WardrobeMixMatchTab mixMatchSlots={interactions.mixMatchSlots} setMixMatchSlots={interactions.setMixMatchSlots} setSlotDrawerCategory={interactions.setSlotDrawerCategory} onSaveFavoriteOutfit={galleryInteractions.handleSaveFavoriteOutfit} setActiveTab={state.setActiveTab} slotDrawerCategory={interactions.slotDrawerCategory} allWardrobeItems={state.allWardrobeItems} wardrobeCategories={state.wardrobeCategories} />}
