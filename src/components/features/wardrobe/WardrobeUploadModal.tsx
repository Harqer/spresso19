        ...
        <div className="space-y-3">
          {uploadPreview ? (
            <div className="relative aspect-square w-48 mx-auto rounded-2xl overflow-hidden border border-[#d8ebd7] shadow-xs">
              <img src={uploadPreview} alt="Upload Preview" onError={(e) => { (e.target as HTMLImageElement).src = "https://placehold.co/400x400/f9fbf9/386633?text=Error"; }} className="w-full h-full object-cover" />
              <button
