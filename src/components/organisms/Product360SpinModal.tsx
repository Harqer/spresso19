    ...
    <div className="bg-gradient-to-b from-stone-900 via-stone-950 to-black text-white rounded-3xl border border-stone-800 w-full max-w-4xl max-h-[92vh] flex flex-col overflow-hidden shadow-2xl my-auto">
      <div className="p-5 border-b border-stone-800 flex items-center justify-between bg-stone-900/50">
        <div className="flex items-center space-x-3">
          ...
          <div><div className="flex items-center space-x-2"><h2 className="font-bold text-base text-white">{spin360Product.name}</h2><span className="px-2 py-0.5 bg-emerald-500/20 text-emerald-400 border border-emerald-500/30 text-[10px] font-mono font-bold rounded-full">GenKit 3D Spin</span></div><p className="text-xs text-stone-400">{spin360Product.brand} · ${spin360Product.price.toFixed(2)} · Cinematic Parallax View</p></div>
        </div>
