              ...
              <div key={prodId} className="bg-white rounded-2xl border border-[#d8ebd7] hover:border-rose-400 transition overflow-hidden shadow-xs flex flex-col justify-between group">
                <div className="relative aspect-square overflow-hidden bg-[#f2f8f2]">
                  ...
                  <button onClick={() => {
                    ...
                    try { localStorage.setItem("spresso_liked_products", JSON.stringify(updated)); } catch {}
                  }} className="absolute top-2 right-2 p-1.5 rounded-full bg-white/90 text-rose-600 hover:bg-rose-600 hover:text-white transition shadow-sm cursor-pointer" title="Remove from Liked">
